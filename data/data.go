...
func initBlogMetadata() {
	...
	metadata["introduction-to-go"] = "4,blog-1-to-20.json"
	metadata["arrays-in-go"] = "3,blog-1-to-20.json"
	metadata["working-with-slices-in-go"] = "2,blog-1-to-20.json"
	metadata["go-types"] = "1,blog-1-to-20.json"
	//metadata["concurrency-in-go"] = "4,blog-1-to-20.json"
	metadata["map-in-go"] = "0,blog-1-to-20.json"
